            ...
            {priorities.map((item, index) => {
              ...
              return (
                <motion.div
                  ...
                  className="group"
                >
                  <div className="relative bg-white rounded-[2rem] p-8 shadow-glass hover:shadow-glass-hover border border-navy/5 transition-all duration-500 hover:-translate-y-2 h-full">
                    <div className="w-14 h-14 rounded-2xl bg-navy/5 flex items-center justify-center mb-6 group-hover:bg-gold/10 transition-colors duration-500">
                      <Icon className="w-7 h-7 text-navy/60 group-hover:text-gold transition-colors duration-500" />
                    </div>
                    <h3 className="font-sans font-bold text-lg text-navy mb-3 tracking-wide">
                      {item.title}
                    </h3>
                    <p className="font-serif text-base text-navy/60 leading-relaxed font-light">
                      {item.body}
                    </p>
                  </div>
                </motion.div>
